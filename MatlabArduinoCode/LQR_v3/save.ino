...
//double K[] = {  -11.9761,-10.4312,-51.4376,-10.2799};
double K[] = {0.881787,0.62646683,4.59378369,-0.07029587};
...
void loop() {
    if (micros() - currentTimeMicros > 20000) {
        ...
        //if (printFlag && isActive && bounceCounter > 50) {
        if (printFlag) {
            printAllStates();
        }
    }
